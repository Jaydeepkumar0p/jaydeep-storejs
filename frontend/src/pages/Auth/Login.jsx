...
import { Eye, EyeOff, Loader2, Lock, Mail, Zap, ArrowRight, Shield } from "lucide-react";
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="text-center mb-8 animate-slide-down">
          <div className="flex justify-center mb-4">
            <div className="p-4 bg-gradient-to-br from-orange-500/20 to-orange-600/10 rounded-2xl border border-orange-500/30">
          ...
          <div className="h-1.5 w-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full mx-auto mb-4"></div>
